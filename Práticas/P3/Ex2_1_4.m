...
% Maneira de dar print com num2str que vem de raíz do MatLab e que converte um
% numero para string. No entanto, desta maneira, é preciso criar uma
% variável e depois ainda fazer disp(n_variavel)
...
% Outra maneira de fazer o print todo na mesma linha com fprintf
fprintf('O menor número de pessoas é (prob = 0.9) %2d\n ',n1)
